...
export const actionCreators = {
    ...
    updateUpperAlignersAction: (visitAligner: VisitAligner ) => <UpdateUpperAlignersAction>{ type: 'UPDATE_UPPER_ALIGNERS', visitAligner },
    updateLowerAlignersAction: (visitAligner: VisitAligner ) => <UpdateLowerAlignersAction>{ type: 'UPDATE_LOWER_ALIGNERS', visitAligner },
